...
function ArticelsOfAssociation({
  articelsOfAssociation,
}: ArticelsOfAssociationProps) {
  return (
    <>
      <Head>
      ...
      <Container>
        <ContentWrapper>
          <Divider>Vereinssatzung</Divider>
          <Content>
            <Markdown
              components={{
                img: ({ ...props }) => (
                ...
                li: Li,
                h4: ({ children }: any) => (
                  <HeadlineItemFour headline={4}>{children}</HeadlineItemFour>
                ),
                h5: ({ children }: any) => (
                  <HeadlineItemFive headline={5}>{children}</HeadlineItemFive>
                ),
              }}
            >
...
export async function getStaticProps() {
  const responseArticelsOfAssociation = await apiFetch("/vereinssatzung");
